  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        />
        <Button title="Search" color="#841584" onPress={getPosition} />
      </View>
      {isLoading ? (
       ...
       ): <Image style={{width:100,height:100,marginTop:100}} source={{uri: 'https://img.freepik.com/free-icon/search_318-805848.jpg'}}/>}
    </View>
  );
}
